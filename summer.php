...
<section class="schedule">
    <div class="container">
        <div class="row">
            ...
            the end of the session for belt upgrade. The table below lists the class descriptions
            and schedules.
            ...
            <table class="summer">
                ...
                <tr>
                    ...
                    <td>1</td>
                    <td>Basic Taekwondo</td>
                    <td>1</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Self Defense and Poomsae</td>
                    <td>2</td>
                </tr>
                <tr>
            ...
            <div style="text-align:center;"><u>Summer Taekwondo Rates</u></div>
            <table class="summer">
                <tr>
                    <td>&nbsp;</td>
